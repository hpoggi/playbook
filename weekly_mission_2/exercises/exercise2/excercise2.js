...
console.log('2.-Imprime el stack  de cada explorer en la lista, usa FOR EACH')
...
console.log(explorers.filter(exp=>exp.stack.includes('js')))

console.log('5.-Busca el primer explorer que sea de la CDMX, usa FIND')
console.log(explorers.find(exp=>exp.city=='CDMX'))

console.log('6.-Obtén la suma de todos los exercises_completed, usa REDUCE')
console.log(explorers.reduce(
    (previousValue, currentValue) => previousValue + currentValue.exercises_completed,
  0
))
...
console.log(explorers.some(exp=>exp.missions.frontend.isFinished))
...
console.log(explorers.every(exp=>exp.missions.onboarding.isFinished))